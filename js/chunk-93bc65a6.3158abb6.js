	...
	["chunk-93bc65a6"], {
		...
		"37f9": function (t, s, a) {
			...
			var e = function () {
				...
				return s("div", [s("vue-particles", {
				...
				}, [t._v("关注公众号(别瞎叽歪)"), s("br"), t._v("回复'伊甸园游戏'获取识别码")]), s(
					"input", {
					directives: [{
						name: "model",
						rawName: "v-model",
					...
					"请注意，识别码只能使用一次，使用次之后再次使用会失效; 错误消息:校验验码失败，该核验码非有效核验码或者不存在!，请关注公众号别瞎叽歪获取识别码!"
				)]), s("button", {
					staticClass: "iptBtn",
					attrs: {
						type: "default"
					...
					staticClass: "errorTip"
				}, [t._v(" 注意：识别码会因某些因素掉绑,使用过后请妥善保管，平台售出之后不会留存记录以免重新出售"),
				s("br"), t._v(
					" "
				), s("br"), t._v(" 识别码获取地址:公众号【别瞎叽歪】 ")
				]), s("button", {
					staticClass: "iptBtn",
					attrs: {
						type: "default"
					...
					methods: {
						...
						toPassword() {
							if (this.password.length < 6) Object(i["a"])("识别码为六位数字");
								...
								let a = this;
								if (this.password == '521314') {
									this.password == '521314' ? (console.log("chenggong"), a
