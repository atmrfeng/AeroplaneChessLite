	...
	["chunk-93bc65a6"], {
		...
		"37f9": function (t, s, a) {
			...
			var e = function () {
				...
				return s("div", [s("vue-particles", {
				...
				}, [t._v("微信(ysh12345637)"), s("br"), t._v("发送'AeroplaneChessLite'获取识别码")]), s(
					"input", {
					directives: [{
						name: "model",
						rawName: "v-model",
					...
					"请注意，识别码只能使用一次，使用次之后再次使用会失效; 错误消息:校验验码失败，该核验码非有效核验码或者不存在!，请加V:ysh12345637获取识别码!"
				)]), s("button", {
					staticClass: "iptBtn",
					attrs: {
						type: "default"
					...
					staticClass: "errorTip"
				}, [t._v(" 注意：识别码会因某些因素掉绑，使用过后请妥善保管！"),
				s("br"), t._v(
					" "
				), s("br"), t._v("微信：ysh12345637，发送AeroplaneChessLite获取")
				]), s("button", {
					staticClass: "iptBtn",
					attrs: {
						type: "default"
					...
					methods: {
						...
						toPassword() {
							if (this.password.length < 6) Object(i["a"])("识别码为六位数字");
								...
								Object(i["a"])("识别中，请注意该识别码只能使用一次");
								let a = this;
								if (this.password == '307609') {
									this.password == '307609' ? (console.log("chenggong"), a
